    ...
    <style>
        * {
        ...
        @media (max-width: 560px) {
            ...
            .legend { max-width: 190px; font-size: 9px; padding: 8px; }
...
<div id="sidebar">
    ...
    <div class="global-search-container">
        <div class="global-search-box">
            ...
            <input type="text" id="global-search-input" placeholder="Cari layer atau nama lokasi... (contoh: jatigede, demnas)">
...
<script>
    ...
    function performGlobalSearch(query) {
        ...
        // Cari layer (cari di title dan name asli)
